...
import com.livestreaming.tv.databinding.FragmentLoginOtpScreenBinding
import com.livestreaming.tv.utils.OTPState
import com.livestreaming.tv.viewmodels.OtpViewModel
    ...
    private fun setupView() {
        with(binding) {
            btnVerify.setOnClickListener {
                findNavController().navigate(LoginOtpScreenFragmentDirections.actionLoginOtpScreenFragmentToUserSelectionFragment())
            }
        }
    }
