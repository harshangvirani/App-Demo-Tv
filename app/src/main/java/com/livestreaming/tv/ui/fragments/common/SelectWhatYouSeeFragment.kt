...
import com.livestreaming.tv.adapter.SelectWhatYouSeeAdapter
import com.livestreaming.tv.databinding.FragmentSelectWhatYouSeeBinding
    ...
    private fun setupNextButton() {
        binding.btnNext.setOnClickListener {
            ...
            if (selectedGenres.isEmpty()) {
                ...
                findNavController().navigate(SelectWhatYouSeeFragmentDirections.actionSelectWhatYouSeeFragmentToLoginWthSelectionFragment())
            }
        }
    }
}